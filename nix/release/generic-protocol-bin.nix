...
in rec {
  "octez-accuser-${protocol-name}" = ocamlPackages.buildDunePackage rec {
  ...
  "octez-smart-rollup-client-${protocol-name}" = ocamlPackages.buildDunePackage rec {
  ...
  "octez-smart-rollup-node-${protocol-name}" = ocamlPackages.buildDunePackage rec {
